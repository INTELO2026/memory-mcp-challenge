"""Stockage SQLite + recherche par similarité cosinus sur embeddings denses.

Les vecteurs d'embeddings sont calculés via :mod:`memory_mcp.embeddings`
(cascade Gemini -> sentence-transformers -> repli hashing) puis **mis en cache**
dans la colonne ``embedding`` pour éviter tout recalcul à la recherche.
"""
...
from memory_mcp.embeddings import cosine_similarity, get_embedder
